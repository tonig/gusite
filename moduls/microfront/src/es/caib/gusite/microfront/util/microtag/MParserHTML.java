...
public class MParserHTML {
	...
	/**
	 * Método que devuelve un string preparado para insertar en un html.
	 * Ese string contiene el trozo del selector
	 * @param nombre
	 * @param valores
	 * @param tipo
	 * @param lineas
	...
	/**
	 * Método que devuelve un string preparado para insertar en un html.
	 * Ese string contiene el trozo del TextArea
	 * @param nombre
	 * @param columnas
	 * @param lineas
	 * @param obligatorio
	...
	/**
	 * 	Método que devuelve un string preparado para insertar en un html.
	 * Ese string contiene el trozo del tag de texto
	 * @param nombre
	 * @param longitudtexto
	 * @param obligatorio
	 * @return StringBuffer
			...
			for (int i=0;i<n;i++) {
			    ...
			    if (pos_propertyid!=-1) {
			    	...
			    	int nprop=stprop.countTokens();
	        	  	...
	        	  	if (nprop==2) { //al segundo hay que comprobar si tiene comillas y quitarselas
	...
	public String tagCSS(Long idsite, Long idcss, String idcsspatron) {
		...
		if (_version.equals("S")) {
			...
			if ((idsite!=null) && (idcss!=null)) {
				retorno="<link href=\"" + MicroURI.uriImg(Microfront.RMICROSITE, idsite.longValue(), idcss.longValue()) + "\" rel=\"stylesheet\" type=\"text/css\" />";
				...
				if (_version.equals("N")) {
					...
					retorno+="<link href=\"v1/css/estils_print.css\" rel=\"stylesheet\" type=\"text/css\" media=\"print\" />";
				} else {

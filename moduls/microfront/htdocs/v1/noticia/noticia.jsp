									...
									<div id="infoNoticia">
										<logic:present name="MVS_noticia" property="traduce">
											...
											<logic:notEmpty name="MVS_noticia" property="imagen">
												<img id="imgNoticia" src="archivopub.do?ctrl=<bean:write name="MVS_servicio"/><bean:write name="MVS_noticia" property="id" />ZI<bean:write name="MVS_noticia" property="imagen.id" />&amp;id=<bean:write name="MVS_noticia" property="imagen.id" />&amp;nombre=<bean:write name="MVS_noticia" property="imagen.nombre" />" alt="" />							
											</logic:notEmpty>

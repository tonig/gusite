...
Insert into GUS_MUSUAR (MSU_CODI,MSU_USERNA,MSU_PASSWO,MSU_NOMBRE,MSU_OBSERV,MSU_PERFIL) values (10000000,'gusite','gusite','Usuario tests','tic@portsib.es','gusadmin');
